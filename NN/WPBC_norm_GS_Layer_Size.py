'''
The following script performs a grid search on the normalized WPBC dataset to determine the optimal size for a
...
dataset = numpy.loadtxt("WPBC_norm.csv", delimiter=",")
