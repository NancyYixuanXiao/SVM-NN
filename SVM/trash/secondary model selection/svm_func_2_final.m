...
[U,S,V] = svds(feature,28); feat_svd_1 =U*S*V';
[U,S,V] = svds(feature,26); feat_svd_2 =U*S*V';
[U,S,V] = svds(feature,24); feat_svd_3 =U*S*V';
[U,S,V] = svds(feature,22); feat_svd_4 =U*S*V';
[U,S,V] = svds(feature,20); feat_svd_5 =U*S*V';
[U,S,V] = svds(feature,18); feat_svd_6 =U*S*V';
...
parfor i = 1:8
    ...
    C_rbf = 2^(i+8);
        ...
        [CCR9] = svm_func_1_final('linear','QP',feat_svd_4,label,0,C_lin);
        [CCR10] = svm_func_1_final('linear','QP',feat_svd_5,label,0,C_lin);
        [CCR11] = svm_func_1_final('linear','QP',feat_svd_6,label,0,C_lin);
